	...
	ensureBootstrap: function(cb, options){
		...
		checkForBootstrapped = function(justNeedsBootstrap, needsBootstrapRuleset) {
            return wrangler.bootstrapCheck(function(json) {
				console.log(json);
				if ($.inArray('b507199x0.dev', json.rids) > -1 && $.inArray('v1_wrangler', json.rids) > -1) {
...
// ------------------------------------------------------------------------ Rulesets 
    getRulesets: function(cb, options) 
    {
        ...
        return wrangler.skyQuery(Devtools.get_rid("rulesets"), "registeredRulesetsInfo", {}, post_function, options);
    },
/*  ----------Old code---------- 
